...
EDGE_CASES = {
    ...
    'malformed-image-labels': EdgeCase(
        'malformed-image-labels',
        'inline',
        lambda size: '![' * size + 'text' + ']' * size + '\n',
        commonmark_app,
        (1000, 10000, 100000),
    ...
    'empty-label-unclosed-destinations': EdgeCase(
        'empty-label-unclosed-destinations',
        'inline',
        lambda size: '[](' * size + '\n',
        commonmark_app,
        (1000, 10000, 100000),
    ...
    'flat-mixed-emphasis': EdgeCase(
        'flat-mixed-emphasis',
        'inline',
        lambda size: '*a_b' * size + '\n',
        commonmark_app,
        (1000, 10000, 100000),
        streaming_app,
    ),
